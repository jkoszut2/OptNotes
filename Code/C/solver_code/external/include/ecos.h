...
// The "pwork" data type is used to create a workspace variable which contains
// all the variables corresponding to the problem
...
void createKKT_U(spmat* Gt, spmat* At, cone* C, idxint** S, spmat** K,
                 idxint* AttoK, idxint* GttoK); // from preproc.c
